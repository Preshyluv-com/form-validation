...
<!-- the below is executed when submit button is clicked -->
        <p class="lead"><?php $fname ?></p>
        <p class="lead"><?php $lname ?></p>
        <p class="lead"><?php $email ?></p>
        <p class="lead"><?php $password ?></p>
        <p class="lead"><?php $address ?></p>
        <p class="lead"><?php $address2 ?></p>
        <p class="lead"><?php $city ?></p>
        <p class="lead"><?php $state ?></p>
        <p class="lead"><?php $zip ?></p>
    </div>
